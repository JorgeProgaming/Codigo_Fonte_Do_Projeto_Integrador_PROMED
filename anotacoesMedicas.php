      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="container">
          <div class="py-5 text-center">
            ...
            <p class="lead">Insira as informações abaixo pedidas para fazer anotações no paciente desejado</p>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-8 order-md-1">
              ...
              <form class="needs-validation" novalidate action="anotacoesMedicasSalvar.php" method="post">
                  ...
                  <div class=" mb-4">
                    ...
                    <div class="invalid-feedback">
                     ...
                     <div class="form-group">
                        ...
                        <textarea name="anotacaoMedica" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                     </div>
                  </div>
