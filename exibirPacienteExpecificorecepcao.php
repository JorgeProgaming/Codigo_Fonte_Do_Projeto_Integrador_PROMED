    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-success  fixed-top" id="sideNav">
      ...
      <div class="collapse navbar-collapse bg-success" >
        <ul class="navbar-nav bg-success">
          ...
          <li class="nav-item">
              <a class="nav-link js-scroll-trigger text-white" href="cadastrarFuncionario.php">Cadastrar Funcionario</a>
          </li>
          <li class="nav-item">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-md-8 order-md-1">
              ...
              <form class="needs-validation" novalidate action="exibirPacienteEspecificoDados.php" method="post">
