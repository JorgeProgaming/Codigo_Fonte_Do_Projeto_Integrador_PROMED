    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-success  fixed-top" id="sideNav">
      ...
      <div class="collapse navbar-collapse bg-success" >
        <ul class="navbar-nav bg-success">
          ...
          <li class="nav-item">
              <a class="nav-link js-scroll-trigger text-white" href="exibirPacientesEnfermeiro.php">Exibir Pacientes</a>
          </li>

          <li class="nav-item">
              <a class="nav-link js-scroll-trigger text-white" href="anotacoesEnfermeiro.php">Fazer anotaçoes</a>
          </li>
              <li class="nav-item">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="container">
          <div class="py-5 text-center">
            ...
            <h2>Fazer Anotações</h2>
            <p class="lead">Insira as informações abaixo pedidas para fazer anotaçoes no paciente desejado</p>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-8 order-md-1">
              ...
              <form class="needs-validation" novalidate action="anotacoesEnfermeiroSalvar.php" method="post">
                
                  <div class=" mb-4">
                    <label for="primeiroNome">Nome do paciente </label>
                    <input name="nome"type="text" class="form-control" id="primeiroNome" placeholder="" value="" required>
                    <div class="invalid-feedback">
                      É obrigatório inserir um nome válido.
                    </div>
                     <div class="form-group">
                        <label for="exampleFormControlTextarea1">Anotações Medicas</label>
                        <textarea name="anotacaoEnfermeiro" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                     </div>
                  </div>
