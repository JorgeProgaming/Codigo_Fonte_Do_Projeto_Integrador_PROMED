  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-success  fixed-top" id="sideNav">
      ...
      <div class="collapse navbar-collapse bg-success" >
        <ul class="navbar-nav bg-success">
          ...
          <li class="nav-item">
              <a class="nav-link js-scroll-trigger text-white" href="anotacoesEnfermeiro.php">Fazer anotações</a>
          </li>
              <li class="nav-item">
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          <h1 class="mb-0">O que voce deseja exibir ? </h1>
            <br>
            <br>
            <br>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-lg-8 mx-auto">
                      ...
                      <a class="btn btn-success btn-lg btn-block" href="exibirTodosOsPacientesenf.php" role="button">Todos os Pacientes</a>
                        <a class="btn btn-success btn-lg btn-block" href="exibirPacienteExpecificoenf.php" role="button">Paciente Especifico</a>
