              ...
              <div class="container">
                <div class="row">
                  <div class="col-lg-8 mx-auto">
                      ...
                      <a class="btn btn-success btn-lg btn-block" href="exibirTodosOsPacientesmedico.php" role="button">Todos os Pacientes</a>
                      <a class="btn btn-success btn-lg btn-block" href="exibirPacienteExpecificomedico.php" role="button">Paciente Especifico</a>
